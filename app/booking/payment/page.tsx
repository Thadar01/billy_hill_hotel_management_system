              ...
              <div className="grid grid-cols-3 gap-6 mb-10">
                {[
                  ...
                  <button
                    ...
                    className={`flex flex-col items-center justify-center py-6 px-4 rounded-2xl border-2 transition-all duration-300 group ${paymentMethod === method.id
                        ...
                        <div>
                          ...
                          <div className="flex gap-3">
                            ...
                            <button
                              ...
                              className={`px-5 py-3 rounded-xl text-xs sm:text-sm font-bold transition-all shadow-sm ${isMobileConnected
